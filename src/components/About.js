...
import { faJs, faHtml5, faCss3Alt, faBootstrap, faReact, faNodeJs, faNpm, faGitAlt, faGithub } from "@fortawesome/free-brands-svg-icons";
    ...
    <div className='skills-container'>
      ...
      <div className="resume-container">
        ...
        <div className="summery resume">
          <a href="/path/to/resume.pdf" download><span>Download</span><FontAwesomeIcon icon={faFile} /></a>
        </div>
      </div>
